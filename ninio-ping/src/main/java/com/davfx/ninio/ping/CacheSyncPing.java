...
public final class CacheSyncPing implements SyncPing {
	...
	private static final Config CONFIG = ConfigFactory.load(CacheSyncPing.class.getClassLoader());
	private static final int CACHE_SIZE = CONFIG.getInt("ninio.ping.cache.size");
	private static final double CACHE_EXPIRATION = ConfigUtils.getDuration(CONFIG, "ninio.ping.cache.expiration");
