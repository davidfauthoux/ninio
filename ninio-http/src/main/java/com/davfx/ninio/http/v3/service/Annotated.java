...
public final class Annotated {
	...
	private static final String RESOURCES = CONFIG.getString("ninio.http.service.resources");
	private static final String INDEX = CONFIG.getString("ninio.http.service.index");
